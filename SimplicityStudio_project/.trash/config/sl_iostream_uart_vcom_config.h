...
#define SL_IOSTREAM_USART_VCOM_FLOW_CONTROL_TYPE     uartFlowControlNone
...
// <i> Default: 0
#define SL_IOSTREAM_UART_VCOM_CONVERT_BY_DEFAULT_LF_TO_CRLF     1
...
// <<< sl:start pin_tool >>>
// <usart signal=TX,RX,(CTS),(RTS)> SL_IOSTREAM_UART_VCOM
// $[USART_SL_IOSTREAM_UART_VCOM]
